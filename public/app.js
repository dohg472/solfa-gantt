...
const DEFAULT_TASK_PROJECT_OVERRIDES = new Map([
  ...
  ["3959a919c6cd800596c4caed97b26bc9", "[양홍원] EP.8 홍원, 현주 데이트 + EP.9 양루아 땡깡 브이로그"],
  ["3959a919c6cd80a79c45d597216c1123", "[양홍원] EP.8 홍원, 현주 데이트 + EP.9 양루아 땡깡 브이로그"],
  ["3969a919c6cd80139195c925c2ad2fb6", "[양홍원] EP.8 홍원, 현주 데이트 + EP.9 양루아 땡깡 브이로그"],
  ["3a59a919c6cd806aa3a3ebbf5855211f", "[양홍원] EP.12 루아의 여름방학 + 번외편 찐템소개"],
  ["3999a919c6cd80f7bb4fe6bb547ee78d", "[양홍원] EP.12 루아의 여름방학 + 번외편 찐템소개"],
  ["3a79a919c6cd8006bf13d10b3357237f", "[양홍원] EP.12 루아의 여름방학 + 번외편 찐템소개"],
  ["39f9a919c6cd801f8f30db9311b4b91c", "[양홍원] EP.10 바버샵에 간 루아 (헤어그로우)"],
  ["3999a919c6cd80e2897fc484fe605c1b", "[양홍원] EP.10 바버샵에 간 루아 (헤어그로우)"],
  ["39f9a919c6cd8067bcbae357e8b7a796", "[양홍원] EP.11 청첩장모임 (W/스윙스, 노창, 한요한, 키드밀리, 노엘)"],
  ["3999a919c6cd80b8b219e1869fa08c5a", "[양홍원] EP.11 청첩장모임 (W/스윙스, 노창, 한요한, 키드밀리, 노엘)"],
]);
...
function inputFieldMarkup(field, index) {
  ...
  if (type === "choice") {
    ...
    const customValue = allowCustom && !hasSelectedOption ? value : "";
    ...
    return `
      <div class="input-field" data-input-field-name="${escapeHtml(name)}" data-input-choice-name="${escapeHtml(name)}" role="group" aria-labelledby="${inputId}Label">
        ...
        ${allowCustom ? `<input class="input-choice-custom" data-input-choice-custom type="text" value="${escapeHtml(customValue)}"${customPlaceholder} aria-label="${escapeHtml(label)} 직접 입력" />` : ""}
      </div>
    `;
  }
...
function normalizeInputOptions(options) {
  ...
  return options
    .map((option) => {
      if (typeof option === "string") return { value: option, label: option, meta: "" };
      return {
